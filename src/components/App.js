...
function App() {
  ...
  return (
    <div className="page">
      ...
      />
      <PopupWithForm name="add-image" title="Новое место" isOpen={isAddPlacePopupOpen} children={
        <>
      ...
      />
      <PopupWithForm name="avatar-change" title="Обновить аватар" isOpen={isEditAvatarPopupOpen} children={
        <>
